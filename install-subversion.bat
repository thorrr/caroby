...
pushd .
:: User modifiable ::::::::::::::
set SVN_VERSION=1.8.8
set md5sum=0f5fe0eaa6d0d566b90ce0fa8d17c230
:::::::::::::::::::::::::::::::::

set URL=http://iweb.dl.sourceforge.net/project/win32svn/%SVN_VERSION%/apache24/svn-win32-%SVN_VERSION%-ap24.zip
set packageName=svn-%SVN_VERSION%
...
set svnZip=%_rv%
call :verifyMD5Hash "%CD%\%svnZip%" %md5sum% || goto :error
call :installPath %packageName%
set installDir=%_rv%
call :mktemp /D || goto :error
call :UnZipFile "%_rv%" "%CD%\%svnZip%" || goto :error
move "%_rv%\svn-win32-%SVN_VERSION%" "%installDir%" >nul
popd

::build init
call :initPath %packageName% || goto :error
mkdir "%_rv%"
set initName=%_rv%\svn-init.bat
call :installPathRelative %packageName% || goto :error
set svnDir=%_rv%
>"%initName%" echo @echo off
>>"%initName%" echo.
>>"%initName%" echo set PATH=%svnDir%\bin;%%PATH%%
